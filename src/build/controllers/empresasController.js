...
class EmpresasController {
    ...
    mostrar_todos_empresa(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const respuesta = yield database_1.default.query('SELECT * FROM empresas');
            res.json(respuesta);
        });
    }
    mostrar_empresa(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT * FROM empresas WHERE id = ?', [id]);
